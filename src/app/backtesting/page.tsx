      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="card p-4">
            ...
            <p className="text-sm text-rose-700 dark:text-rose-300 mb-2">Export the "List of trades" from a TradingView backtest (if available). We auto-detect a Profit/P&amp;L column.</p>
            <form className="flex gap-2 items-center" action="/api/backtest/import" method="POST" encType="multipart/form-data">
              ...
              <input name="strategy_tag" placeholder="strategy tag (optional)" className="input" />
          ...
          <div className="card p-4">
            ...
            <div className="grid sm:grid-cols-2 gap-2">
              ...
              <label className="text-sm">ORB (min) <input type="number" value={orb} onChange={e=>setOrb(+e.target.value)} className="input"/></label>
              ...
              <label className="text-sm">Tag <input value={tag} onChange={e=>setTag(e.target.value)} className="input"/></label>
            </div>
            <div className="mt-3">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-rose-500">
                ...
                <th className="p-2">Win%</th><th className="p-2">PF</th><th className="p-2">Max DD</th><th className="p-2">Source</th><th className="p-2">Randomization</th>
              </tr>
            </thead>
            <tbody>
              ...
              {rows.map((r:any)=>(
                <tr key={r.id} className="border-t">
                  ...
                  <td className="p-2"><button onClick={()=>permute(r.id)} className="px-2 py-1 text-xs rounded bg-rose-600 text-white">Run</button></td>
                </tr>
              ))}
            </tbody>
          </table>
